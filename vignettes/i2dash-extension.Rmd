...
The easiest way to create the desired structure is to click in RStudio on **File** -> **New Project**. In the modal dialog we select **New Directory**, then **R Package**.
...
Finally, we set a package name, select the directory, where the new package structure will be created and click on **Create Project**.
